...
class CrossAttention(nn.Module):
    ...
    def forward(self, motion_features, text_features):
        Q = self.query_proj(motion_features)
        ...
        # Add a residual connection with motion_features
        return attention_output + motion_features
...
class MotionTextClassifier(nn.Module):
    ...
    def forward(self, motion, text):
        ...
        # Reverse the cross-attention inputs
        attended_features = self.cross_attention(motion_features, text_features)
...
def main(output_path, log_path):
    ...
    test_metrics = test_model(model, test_loader, criterion, config.model.num_classes)
...
if __name__ == "__main__":
    root = "D:\\MingYuan\\A2M"
    output_path = os.path.join(root, "MTClassifier-frame_CA_M2T_motion128text4_period32")
